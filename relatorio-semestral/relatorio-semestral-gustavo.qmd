...
Os resultados obtidos por esses autores funcionam apenas para ganho e perda de um real por aposta. Altere o
dinheiro disputado por lançamento, introduza a possibilidade de empate ou crie relações de dependência entre todos os
lançamentos
...
Empregando-se simulações, conseguimos verificar os casos nos quais estimador é ou não adequado. Exploramos os jogos em que o
...
jogador A, $N$
representa o dinheiro total em aposta $N=a+b$, com $b$ o saldo do jogador B, e $X$ a variável aleatória que representa as
...
Não se tratou de um resultado isolado. Sob diferentes regras, o estimador ([-@eq-estimador]), majoritariamente, mostrou forte
concordância com os valores simulados. 
...
Não obstante, vale notar que, quanto menor $E(X)$, mais impreciso mostra-se o estimador.

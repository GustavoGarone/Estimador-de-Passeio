...
ganho e perda de um real por aposta. Os métodos utilizados para calcular analíticamente a esperança da duração do jogo
...
A [@tbl-simulados], gerada pelo código presente no Apêndice B, destaca que o estimador fornece uma aproximação da
esperança da duração de um jogo com regras diversas.
...
display(LaTeXString("Resultados:\nMédia da duração de \$1000000\$ passeios: \$$(round(media, digits=2))\$"))
...
# Apêndice B — Código de simulação de jogos com regras mais complexas na linguagem Julia

...
#%%
# Apenas avanço
# Um passeio aleatório de inicio a tamanho
# O jogador anda 1 casa ou fica parado
# P(Avançar | está na casa I) = 1 - I/tamanho
# Começa no inicio e ganha quando chega no tamanho

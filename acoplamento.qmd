---
format: pdf
title: "Acoplamento de passeios aleatórios: uma abordagem ingênua"
engine: julia
---
...
a = simula()
println("Média dos passeios $(mean(a))")
println("Variância dos passeios $(var(a))")
println("Quantis dos passeios $(quantile(a))")
box = boxplot(a)
display(box)
